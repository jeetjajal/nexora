...
public class StoreController {
    ...
    /**
     * Any authenticated user (any role) can browse stores. Paginated —
     * e.g. GET /api/v1/stores?page=0&size=10&sort=name,asc
     */
    @GetMapping
    public ResponseEntity<ApiResponse<Page<StoreResponse>>> getAllStores(
            @PageableDefault(size = 10) Pageable pageable) {

        Page<StoreResponse> response = storeService.getAllStores(pageable);
